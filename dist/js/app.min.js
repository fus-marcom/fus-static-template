...
"use strict";$(function(){function l(){$(window).scroll(function(){$(window).scrollTop()>1500?$(".scroll-to-top").removeClass("slide-out").addClass("slide-in"):$(".scroll-to-top").removeClass("slide-in").addClass("slide-out")})}var o=new Date,s=o.getFullYear();$("#copyright-date").text(s),$(".scroll-to-top i").click(function(){return $("html, body").animate({scrollTop:0},1e3),!1}),$(window).scrollTop()>1500?$(".scroll-to-top").removeClass("slide-out").addClass("slide-in"):$(".scroll-to-top").removeClass("slide-in").addClass("slide-out"),l(),$(".modal-trigger").leanModal();var t=$(window).width(),e=!1;t<992&&(e=!0),$(".button-collapse").sideNav({closeOnClick:e,menuWidth:300})});